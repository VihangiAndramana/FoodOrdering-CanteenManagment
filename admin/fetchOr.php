...
$query = '';
$output = array();
$query .= "SELECT o.order_id, o.product_id, o.order_qty, o.order_price, o.date, o.time, p.product_title, c.customer_name, o.checkStatus FROM orders o JOIN products1 p ON o.product_id = p.products_id JOIN customer c ON o.c_id = c.customer_id  ";
