            ...
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>KDUSC Canteen</span>
                        </a>
                    </div>
                    <ul>
                        <li>+94 071 1234567</li>
                        <li>kdusccateen@kdu.ac.lk</li>
                        <li>KDU Southern Campus,
                            Nugegalayaya, Sooriyawewa</li>
                    </ul>
                ...
                <div class="footer-widget" style="display: <?php if ($active == 'Register' || $active == 'Login') {
                    ...
                    <ul>
                        ...
                        <?php if (!($_SESSION['customer_email'] == 'unset')) {
                            echo "<li><a href='account.php?orders'>My </a></li>";
                        } ?>
                        <li><a href="
                        <?php if (!($_SESSION['customer_email'] == 'unset')) {
