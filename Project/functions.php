...
$db = mysqli_connect('localhost', 'root', '', 'canteenDb');
 ...
 global $db;
    ...
    if (isset($_GET['add_cart'])) {
        ...
        if (mysqli_num_rows($run_check) > 0) {
            ...
            echo "<script>window.open('product.php?products _id=$p_id','_self')</script>";

        } else {

            $query = "Insert into cart (products_id, ip_add,qty,size,date,c_id) values('$p_id','$ip_add','$qty','60',NOW(),'$c_id')";
            $run_query = mysqli_query($db, $query);


            echo "<script>alert('Product added to Cart. Keep Shopping.')</script>";
            echo "<script>window.open('product.php?products_id=$p_id','_self')</script>";
        }
    }
}
...
//     $get_products = "select * from products1 where cat_id='ca02' order by RAND() LIMIT 7";
...
function getMProduct()
{
    ...
    $get_products = "select * from products1 where cat_id='6'";
    $run_products = mysqli_query($db, $get_products);
...
function getProdCat()
{
    ...
    $get_p_cats = "select * from availability";
...
function getPcatProd()
{
    ...
    if (isset($_GET['p_cat_id'])) {
        ...
        $get_products = "select * from products1 where p_cat_id='$p_cat_id'";
        $run_products = mysqli_query($db, $get_products);
...
function getcatProd()
{
    ...
    if (isset($_GET['cat_id'])) {
        ...
        $get_products = "select * from products1 where cat_id='$cat_id'";
        $run_products = mysqli_query($db, $get_products);
...
function getProd()
{
    ...
    if (isset($_GET['products_id'])) {
        ...
        $get_product_id = "select * from products1 where products_id='$products_id'";
        ...
        $get_p_cat_name = "select p_cat_title from products1 as P,availability as C where P.p_cat_id=C.p_cat_id and products_id='$products_id'";
        ...
        // $get_available_item = "select * from sales where products_id = '$products_id'";
        // $run_get_available_item = mysqli_query($db, $get_available_item);

        // $row_get_available_item = mysqli_fetch_array($run_get_available_item);
      

        // $amount = $row_get_available_item['rest_amount'];
...
function relatedProducts()
{
    ...
    if (isset($_GET['products_id'])) {
        ...
        $get_p_cat_id = "select C.p_cat_id,C.p_cat_title from products1 as P,availability as C where P.p_cat_id=C.p_cat_id and products_id=$products_id";
        ...
        $get_r_products = "select * from products1 where p_cat_id=$pcat_id LIMIT 1,4";
        ...
        <div class='col-lg-3 col-sm-6'>
            <div class='product-item' >
                <div class='pi-pic' style='max-height:300px'>
                    ...
                    <ul>
                        <li class='quick-view'><a href='product.php?products_id=$p_id' style='background:#fe4231;color:white'>View Details</a></li>
                    </ul>
                </div>
                <div class='pi-text'>
                    <a href='#'>
...
function total_price()
{
    ...
    while ($row_items = mysqli_fetch_array($run_items)) {
        ...
        $get_price = "select * from products1 where products_id = '$p_id'";
    ...
    <div class='card col-md-3 col-10' style='margin:0 auto; border-radius:25px 5px;box-shadow: inset -12px -8px 40px #e5e5e5;'>
        ...
        <tr style='border-bottom: 0.5px solid #ebebeb'>
           ...
           <td class='cart-title first-row'>
               <h5><a href='product.php?products_id=$pro_id' style='color:white;font-weight:bold'>$pro_name</h5>
           </td>
           <td class='p-price first-row'>Rs. $pro_price</td>
           ...
           <td class='total-price first-row'>Rs. $pro_total_p</td>
           <td class='close-td first-row'><a href='shopping-cart.php?del=$pro_id'><i class='ti-close' style='color:white'></i></a></td>
       </tr>    
   ";
        }
    }
...
function cart_icon_prod()
{
    ...
    if (mysqli_num_rows($run_items) == 0) {
        ...
        <p style='text-align:center; font-weight:500;color:#ffffff'>Cart Empty </p>
        ...
        while ($row_items = mysqli_fetch_array($run_items)) {
            ...
            $get_item = "select * from products1 where products_id = '$p_id' ORDER BY date DESC";
            $run_item = mysqli_query($db, $get_item);
